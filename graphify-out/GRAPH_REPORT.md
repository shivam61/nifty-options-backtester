...
## Corpus Check
- 165 files · ~286,129 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3454 nodes · 6554 edges · 269 communities (243 shown, 26 thin omitted)
- Extraction: 69% EXTRACTED · 31% INFERRED · 0% AMBIGUOUS · INFERRED: 2039 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `183f5fc0`
...
1. `main()` - 114 edges
2. `BacktestConfig` - 112 edges
3. `Leg` - 97 edges
4. `RegimeAdaptiveStrategy` - 95 edges
5. `CombinedBacktestEngine` - 88 edges
6. `Trade` - 88 edges
7. `FeatureExtractor` - 82 edges
8. `TradeAction` - 78 edges
9. `price_option()` - 73 edges
10. `TradeResult` - 66 edges
...
Cohesion: 0.05
Nodes (27): ABC, discover(), SourceAdapter, SourceMetadata, build_source_inventory(), CDSLAdapter, _coerce_parenthesized_number(), _extract_cdsl_equity_subtotal() (+19 more)
...
Cohesion: 0.06
Nodes (46): Weekly options backtesting engine.  Simplified engine for 3-8 DTE weekly Nifty o, Event-driven backtester for weekly options.      Key differences from SmartBackt, WeeklyBacktestEngine, WeeklyBacktestResult, WeeklyTradeResult, BaseStrategy, Enum, IronCondorStrategy (+38 more)
...
Cohesion: 0.05
Nodes (34): FillSnapshot, Execution/fill abstractions for separating theoretical marking from executable f, AdjustmentAction, Leg, Apply an adjustment: close specified legs, add new ones, track cost., Apply an adjustment: close specified legs, add new ones, track cost., Check if the trade should be adjusted instead of exited.         Returns an Adju, Check if the trade should be adjusted instead of exited.         Returns an Adju (+26 more)
...
Cohesion: 0.06
Nodes (40): Result of a single completed trade., TradeResult, KillSwitchState, Tracks the DD kill switch state across the backtest., Configuration for weekly (3-8 DTE) options backtesting., Configuration for weekly (3-8 DTE) options backtesting., WeeklyBacktestConfig, BrokenWingButterflyStrategy (+32 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (41): ActiveTrade, add_trade(), add_trade_from_legs(), cache_age_days(), close_trade(), ClosedTradeRecord, ExitRecommendation, _infer_strategy_code() (+33 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (25): Source discovery helpers and adapters., Enrichment and sector proxy helpers., entry_date(), entry_vix(), evaluate_exit(), ExitDecision, _LegAdapter, legs() (+17 more)
...
Cohesion: 0.09
Nodes (16): Factory: create TradeLearner for the active version., Train regime classifier + per-regime entry models.          Args:             tr, ML model that learns from multi-strategy backtests to predict: 1. WHEN to trade, Multi-strategy ML model that learns from regime-adaptive backtests.      Learns:, Train trade-quality filter on backtest results.          Key design changes from, Leakage-safe threshold sweep using out-of-fold scores only., Learn which features drive success for each strategy., Build a regime x strategy performance matrix for ranking priors.          The ma (+8 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (22): analyze_improvements(), determine_winner(), ExitStrategy, Fixed85ExitStrategy, HybridExitStrategy, main(), OriginalExitStrategy, print_comparison_table() (+14 more)

### Community 17 - "Community 17"
Cohesion: 0.11
Nodes (13): _hash_snapshot(), MonthlyDiagnosticsCollector, Monthly-only trade funnel and exit attribution recorder., _safe_float(), _regime_from_vix(), main(), _per_strategy_metrics(), _regime_from_vix() (+5 more)
...
Cohesion: 0.09
Nodes (23): CombinedBacktestEngine, CombinedResult, Combined monthly + weekly options backtesting engine.  Runs both tracks concurre, Concurrent monthly+weekly options backtester on shared capital.      Architectur, Concurrent monthly+weekly options backtester on shared capital.      Architectur, Concurrent monthly+weekly options backtester on shared capital.      Architectur, Return a formatted per-gate funnel summary for monthly trade entry.          Pri, BacktestEngine (+15 more)
...
Cohesion: 0.08
Nodes (22): DrawdownKillSwitch, Hard circuit breaker that activates at max_dd_pct drawdown.      When triggered:, Hard circuit breaker that activates at max_dd_pct drawdown.      When triggered:, Hard circuit breaker that activates at max_dd_pct drawdown.      When triggered:, True on the activation tick — close monthly positions immediately., True on the activation tick — close monthly positions immediately., DrawdownKillSwitch must accept recovery_improvement_pct kwarg., Legacy tests updated for Phase-1 improvement-based recovery.      Old logic: re- (+14 more)
...
Cohesion: 0.13
Nodes (14): Period-aware walk-forward model training and cache management., Expanding-window retraining with period-aware caches.      Every OOS period uses, WalkForwardBundle, WalkForwardManager, WalkForwardWindow, WeeklySimConfig, _cache_path(), WeeklyEntryLearner (+6 more)
...
Cohesion: 0.11
Nodes (18): _filter_trades_in_window(), LayeredEvolveArtifacts, LayeredTrainStage, Layered evolve-time retraining pipeline.  This module keeps model training out o, Train monthly entry/exit models in staged walk-forward layers.      The strategy, run_layered_training(), _sample_stage_windows(), _trade_entry_ts() (+10 more)
...
Cohesion: 0.13
Nodes (17): main(), Test and validate Fyers API connection and data fetching., build_daily_sector_proxy(), main(), _build_engine(), _derive_root_cause(), _flatten_report(), main() (+9 more)
...
Cohesion: 0.11
Nodes (14): metadata_from_state(), ModelPeriodMetadata, cache_age_days(), load(), Regime-Aware Entry Model: trains separate TradeLearner per market regime.  Inste, Wraps multiple TradeLearners — one per regime.      Replaces the single global T, load(), Weekly Entry Learner — lightweight ML quality gate for short-DTE weekly options. (+6 more)
...
Cohesion: 0.13
Nodes (11): get_best_expiry_for_dte(), get_monthly_expiries(), get_monthly_expiry(), get_next_monthly_expiry(), get_weekly_expiries(), Monthly expiry closest to ``target_dte`` days out. Returns (expiry, actual_dte)., Last expiry day of the month.     Uses Monday for dates >= 2024-04-04, Thursday, All weekly expiry dates (Thursdays or Mondays depending on era) in [start, end]. (+3 more)

### Community 49 - "Community 49"
Cohesion: 0.11
Nodes (12): EntryDecisionEngine, EntryDecisionEngine — single authoritative entry gate shared by backtest, signal, Update the loss-streak counter after a trade closes., Used only if check() itself raises an unexpected exception., Single authoritative entry gate used by backtest, signal, and monitor.      Inst, Run the full entry gate and return an EntryDecision.          Flow:           1., Check if the kill switch should be active.         Returns True if all trading s, Check if the kill switch should be active.         Returns True if all trading s (+4 more)
...
Cohesion: 0.17
Nodes (11): _d1(), _d2(), OptionGreeks, OptionPrice, price_spread(), Black-Scholes option pricing model for estimating Nifty option premiums. Used in, Price a vertical spread (bull put or bear call)., Short leg (closer to ATM) has more theta than long leg (further OTM). (+3 more)
...
Cohesion: 0.15
Nodes (16): format_expiry_label(), Human-readable expiry label, e.g. '28 Apr 2026'., _print_strategy_bs_trade(), _print_strategy_trade(), Generate a strategy-specific trade using live OI data + BS pricing., Generate a strategy-specific trade using live OI data + BS pricing., Generate a strategy-specific trade using live OI data + BS pricing., Fallback: BS-only pricing when live data unavailable. (+8 more)
...
Cohesion: 0.26
Nodes (6): FeatureExtractor, Extracts ML features including cross-geo disruption and macro indicators.      M, FeatureExtractor.extract() must read 'overnight_gap_pct' (the column name     pr, The old stale column name must NOT be in the fixture data., TestFeatureExtractorGapColumn, TestFeatureExtractor
...
Cohesion: 0.21
Nodes (10): EntryDecision, Result returned by EntryDecisionEngine.check()., EntryDecision, Result of the unified multi-expiry entry evaluation., Return a shortlist of regime-appropriate strategies. The circuit breaker, _BlockedStrategy, _DummyEntryModel, test_bwb_can_be_pruned_from_monthly_universe() (+2 more)
...
Cohesion: 0.21
Nodes (11): _expiry_weekday(), get_all_expiries(), get_next_weekly_expiry(), get_upcoming_weekly_expiries(), get_weekly_expiry_in_range(), Nifty option expiry calendar.  NSE moved NIFTY expiries twice in recent years:, Next weekly expiry *after* ``from_date`` (Mon or Thu depending on era).     Retu, Return the first weekly expiry whose DTE falls inside ``[min_dte, max_dte]``. (+3 more)

### Community 84 - "Community 84"
Cohesion: 0.15
Nodes (12): get_upcoming_expiries(), Next ``count`` *monthly* expiries with DTE info.     Weekday is Monday or Thursd, print_oi_analysis(), Print detailed OI analysis around the spot price., _expiry_matches(), Check if the live option chain expiry matches our target., Check if the live option chain expiry matches our target., Check if the live option chain expiry matches our target. (+4 more)

### Community 85 - "Community 85"
Cohesion: 0.19
Nodes (4): Multi-layer risk gate for weekly entries.          Returns None if entry is allo, Multi-layer risk gate for weekly entries.          Returns None if entry is allo, Multi-layer risk gate for weekly entries.          Returns None if entry is allo, Multi-layer risk gate for weekly entries.          Returns None if entry is allo

### Community 86 - "Community 86"
Cohesion: 0.15
Nodes (8): Rough net delta estimate for the weekly spread., Rough net delta estimate for the weekly spread., Compute a continuous [0, 1] scale factor for weekly lot sizing based on, Compute a continuous [0, 1] scale factor for weekly lot sizing based on, Rough net delta estimate for the weekly spread., Compute a continuous [0, 1] scale factor for weekly lot sizing based on, Rough net delta estimate for the weekly spread., Compute a continuous [0, 1] scale factor for weekly lot sizing based on
...
Cohesion: 0.21
Nodes (6): Recommend the best strategy for current conditions.         In hybrid mode, elig, Suggest optimal parameters based on conditions + macro., Extract features from a market data row.          Returns None if critical field, Compute a bounded multiplicative prior from historical regime stats.          Th, Score current market conditions as a trade-quality filter.          The model an, _safe_float()
...
Cohesion: 0.18
Nodes (11): main(), Add a trade — supports both --leg format and legacy single-spread format., Add a trade — supports both --leg format and legacy single-spread format., Add a trade — supports both --leg format and legacy single-spread format., List all active trades with leg details., List all active trades with leg details., List all active trades with leg details., Retrain ML models (entry, exit, weekly-risk) on current feature data using     e (+3 more)
...
Cohesion: 0.33
Nodes (4): ML-driven monthly entry with position sizing and risk caps., ML-driven monthly entry with position sizing and risk caps., ML-driven monthly entry with position sizing and risk caps., ML-driven monthly entry with position sizing and risk caps.
...
Cohesion: 0.4
Nodes (4): VIX-adaptive exits + trailing stops + ML override for monthly., VIX-adaptive exits + trailing stops + ML override for monthly., VIX-adaptive exits + trailing stops + ML override for monthly., VIX-adaptive exits + trailing stops + ML override for monthly.
...
Cohesion: 0.5
Nodes (4): _print_exit_recommendation(), Pretty-print exit recommendation for any multi-leg trade., Pretty-print exit recommendation for any multi-leg trade., Pretty-print exit recommendation for any multi-leg trade.
...
## Knowledge Gaps
- **1491 isolated node(s):** `Check if Fyers token is valid during market hours and show helpful warning if ex`, `Return short git commit hash, or 'unknown' if not in a repo.`, `Aggregate per-strategy stats from trade list.`, `Aggregate sizing decisions from the engine for logging.`, `Append a structured entry to BACKTEST_CHANGELOG.md and backtest_runs.jsonl.` (+1486 more)
...
- **Why does `main()` connect `Community 43` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 9`, `Community 16`, `Community 17`, `Community 26`, `Community 29`, `Community 38`, `Community 40`, `Community 44`, `Community 45`, `Community 54`, `Community 57`, `Community 62`, `Community 64`, `Community 193`, `Community 192`, `Community 69`, `Community 70`, `Community 73`, `Community 84`, `Community 87`, `Community 89`, `Community 93`, `Community 98`, `Community 99`, `Community 104`, `Community 114`, `Community 115`, `Community 116`, `Community 118`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `BacktestConfig` connect `Community 1` to `Community 0`, `Community 2`, `Community 5`, `Community 6`, `Community 16`, `Community 17`, `Community 26`, `Community 27`, `Community 32`, `Community 33`, `Community 38`, `Community 39`, `Community 40`, `Community 43`, `Community 48`, `Community 53`, `Community 54`, `Community 57`, `Community 58`, `Community 73`, `Community 74`, `Community 75`, `Community 76`, `Community 81`, `Community 87`, `Community 89`, `Community 93`, `Community 95`, `Community 99`, `Community 100`, `Community 101`, `Community 105`, `Community 106`, `Community 115`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `CombinedBacktestEngine` connect `Community 26` to `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 136`, `Community 10`, `Community 13`, `Community 17`, `Community 33`, `Community 39`, `Community 43`, `Community 48`, `Community 53`, `Community 58`, `Community 63`, `Community 64`, `Community 74`, `Community 75`, `Community 76`, `Community 85`, `Community 86`, `Community 95`, `Community 100`, `Community 101`, `Community 115`, `Community 117`?**
...
- **Are the 111 inferred relationships involving `BacktestConfig` (e.g. with `SizingDecision` and `_TradeReturn`) actually correct?**
  _`BacktestConfig` has 111 INFERRED edges - model-reasoned connections that need verification._
- **Are the 96 inferred relationships involving `Leg` (e.g. with `FillSnapshot` and `ConservativeFillModel`) actually correct?**
  _`Leg` has 96 INFERRED edges - model-reasoned connections that need verification._
- **Are the 75 inferred relationships involving `RegimeAdaptiveStrategy` (e.g. with `BaseStrategy` and `_DummyEntryModel`) actually correct?**
  _`RegimeAdaptiveStrategy` has 75 INFERRED edges - model-reasoned connections that need verification._