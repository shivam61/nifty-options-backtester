...
## Corpus Check
- 165 files · ~283,593 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3359 nodes · 6419 edges · 251 communities (226 shown, 25 thin omitted)
- Extraction: 69% EXTRACTED · 31% INFERRED · 0% AMBIGUOUS · INFERRED: 2015 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b494316`
...
Cohesion: 0.06
Nodes (30): Walk-forward validation for the entry model (TradeLearner).      Expanding windo, walk_forward_entry_model(), Regime-aware strategy selection., Route to global model's parameter prediction., Print detailed per-regime training report., Persist fitted sklearn models and metadata to disk (no DataFrames)., Factory: create TradeLearner for the active version., Train regime classifier + per-regime entry models.          Args:             tr (+22 more)
...
Cohesion: 0.06
Nodes (37): Initialize Fyers client.                  Args:             client_id: Fyers App, Validate that the connection and authentication are working.                  Re, metadata_from_state(), ModelPeriodMetadata, cache_age_days(), load(), load(), ConditionalGapModel (+29 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (36): Rolling Window Trade Simulator — generates 1000+ training samples from 7 years o, Simulate a single trade from entry to exit., Simulates overlapping trades across the full dataset.      For each entry date (, Run rolling simulations for all strategies and parameter variations., RollingWindowSimulator, SimConfig, Period-aware walk-forward model training and cache management., Expanding-window retraining with period-aware caches.      Every OOS period uses (+28 more)
...
Cohesion: 0.05
Nodes (27): Source discovery helpers and adapters., Enrichment and sector proxy helpers., entry_date(), entry_vix(), evaluate_exit(), ExitDecision, _LegAdapter, legs() (+19 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (32): BacktestEngine, Event-driven backtesting engine.     Steps through each trading day, checks entr, Result of a single completed trade., TradeResult, KillSwitchState, Tracks the DD kill switch state across the backtest., BrokenWingButterflyStrategy, Broken Wing Butterfly (Put side): Asymmetric risk.     Short 2x ATM puts, Long 1 (+24 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (39): ActiveTrade, add_trade(), add_trade_from_legs(), cache_age_days(), close_trade(), ClosedTradeRecord, ExitRecommendation, _infer_strategy_code() (+31 more)
...
Cohesion: 0.09
Nodes (31): analyze_improvements(), determine_winner(), ExitStrategy, Fixed85ExitStrategy, HybridExitStrategy, main(), OriginalExitStrategy, print_comparison_table() (+23 more)

### Community 15 - "Community 15"
Cohesion: 0.09
Nodes (25): CombinedResult, BacktestResult, Aggregate results of a backtest run., FillSnapshot, WeeklyBacktestResult, WeeklyTradeResult, Enum, CostModel (+17 more)
...
Cohesion: 0.07
Nodes (37): _append_changelog_entry(), _build_strategy_breakdown(), _build_weekly_trade_stats(), _get_git_hash(), log_backtest_run(), main(), _print_exit_recommendation(), Return short git commit hash, or 'unknown' if not in a repo. (+29 more)
...
Cohesion: 0.08
Nodes (14): BaseStrategy, generate_legs(), Abstract base class for option strategies., IronButterflyStrategy, IronCondorStrategy, _nan(), PutCreditSpreadStrategy, Multi-strategy module: Iron Butterfly, Put Credit Spread, Broken Wing Butterfly, (+6 more)
...
Cohesion: 0.11
Nodes (18): CombinedBacktestEngine, Combined monthly + weekly options backtesting engine.  Runs both tracks concurre, Concurrent monthly+weekly options backtester on shared capital.      Architectur, Concurrent monthly+weekly options backtester on shared capital.      Architectur, Concurrent monthly+weekly options backtester on shared capital.      Architectur, Return a formatted per-gate funnel summary for monthly trade entry.          Pri, Configuration for weekly (3-8 DTE) options backtesting., Configuration for weekly (3-8 DTE) options backtesting. (+10 more)
...
Cohesion: 0.07
Nodes (17): should_enter(), IronCondorStrategy, Iron Condor strategy with configurable parameters. Adapts strike selection based, Entry rules:         1. VIX must be above 14 (enough premium to collect), Exit rules:         1. Profit target reached (default 50% of max credit), Iron Condor: Sell OTM Call + Sell OTM Put, Buy further OTM Call + Put as hedges., Reprice all legs at current market conditions., Standalone put credit spread — used when call side is too risky     (e.g., stron (+9 more)
...
Cohesion: 0.18
Nodes (7): FeatureExtractor, Extract features from a market data row.          Returns None if critical field, Extracts ML features including cross-geo disruption and macro indicators.      M, FeatureExtractor.extract() must read 'overnight_gap_pct' (the column name     pr, _DummyFeatureExtractor, Tests for models/regime_classifier.py and models/trade_learner.py  Covers: - Rul, TestFeatureExtractor
...
Cohesion: 0.12
Nodes (8): Multi-layer risk gate for weekly entries.          Returns None if entry is allo, Multi-layer risk gate for weekly entries.          Returns None if entry is allo, ML-driven monthly entry with position sizing and risk caps., ML-driven monthly entry with position sizing and risk caps., ML-driven monthly entry with position sizing and risk caps., ML-driven monthly entry with position sizing and risk caps., Multi-layer risk gate for weekly entries.          Returns None if entry is allo, Multi-layer risk gate for weekly entries.          Returns None if entry is allo

### Community 63 - "Community 63"
Cohesion: 0.12
Nodes (20): _expiry_matches(), _print_strategy_bs_trade(), _print_strategy_trade(), Generate a strategy-specific trade using live OI data + BS pricing., Generate a strategy-specific trade using live OI data + BS pricing., Generate a strategy-specific trade using live OI data + BS pricing., Fallback: BS-only pricing when live data unavailable., Fallback: BS-only pricing when live data unavailable. (+12 more)
...
Cohesion: 0.14
Nodes (11): Weekly Entry Learner — lightweight ML quality gate for short-DTE weekly options., Predict quality score for a weekly entry candidate.          Returns quality_sco, Extract features specific to short-DTE weekly trades., ML quality gate for weekly option entries.      Trained on simulated weekly trad, Train the weekly quality gate.          Args:             weekly_trades: list of, _sf(), WeeklyEntryLearner, test_backtest_combined_uses_final_caches_only() (+3 more)
...
Cohesion: 0.16
Nodes (10): Weekly options backtesting engine.  Simplified engine for 3-8 DTE weekly Nifty o, Price the current close-out debit for a multi-leg trade., Compute realized exit P&L.          Baseline uses the current mark-to-market. Re, VIX-based strategy selection for weeklies., Calculate transaction costs for a trade., Execute weekly options backtest., Event-driven backtester for weekly options.      Key differences from SmartBackt, WeeklyBacktestEngine (+2 more)
...
Cohesion: 0.33
Nodes (4): Verify monthly_max_risk_per_trade_pct lowered to 10.0., BacktestConfig.monthly_max_risk_per_trade_pct == 10.0., Risk pct caps lot sizing: at 500k equity and 10% risk, monthly_equity=350k → ris, TestMonthlyMaxRiskPct
...
Cohesion: 0.5
Nodes (4): Run full production model validation: walk-forward + permutation tests for ALL m, Run full production model validation: walk-forward + permutation tests for ALL m, Run full production model validation: walk-forward + permutation tests for ALL m, run_validate()
...
## Knowledge Gaps
- **1421 isolated node(s):** `Check if Fyers token is valid during market hours and show helpful warning if ex`, `Return short git commit hash, or 'unknown' if not in a repo.`, `Aggregate per-strategy stats from trade list.`, `Aggregate sizing decisions from the engine for logging.`, `Append a structured entry to BACKTEST_CHANGELOG.md and backtest_runs.jsonl.` (+1416 more)
...
- **Why does `main()` connect `Community 43` to `Community 0`, `Community 4`, `Community 8`, `Community 9`, `Community 13`, `Community 14`, `Community 19`, `Community 20`, `Community 26`, `Community 30`, `Community 35`, `Community 41`, `Community 42`, `Community 55`, `Community 187`, `Community 63`, `Community 65`, `Community 67`, `Community 68`, `Community 69`, `Community 74`, `Community 75`, `Community 82`, `Community 84`, `Community 92`, `Community 97`, `Community 98`, `Community 106`, `Community 107`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `BacktestConfig` connect `Community 0` to `Community 2`, `Community 3`, `Community 4`, `Community 8`, `Community 10`, `Community 14`, `Community 15`, `Community 19`, `Community 20`, `Community 26`, `Community 33`, `Community 38`, `Community 42`, `Community 43`, `Community 50`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 65`, `Community 66`, `Community 82`, `Community 84`, `Community 87`, `Community 88`, `Community 89`, `Community 92`, `Community 93`, `Community 99`, `Community 106`, `Community 108`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `CombinedBacktestEngine` connect `Community 26` to `Community 0`, `Community 3`, `Community 4`, `Community 6`, `Community 8`, `Community 10`, `Community 14`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 24`, `Community 43`, `Community 50`, `Community 57`, `Community 58`, `Community 62`, `Community 71`, `Community 81`, `Community 87`, `Community 88`, `Community 89`, `Community 90`, `Community 93`, `Community 106`, `Community 108`, `Community 125`?**
