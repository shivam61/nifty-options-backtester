...
## Corpus Check
- 165 files · ~284,373 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3371 nodes · 6434 edges · 270 communities (242 shown, 28 thin omitted)
- Extraction: 69% EXTRACTED · 31% INFERRED · 0% AMBIGUOUS · INFERRED: 2016 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `16d681c3`
...
5. `CombinedBacktestEngine` - 87 edges
6. `Trade` - 87 edges
...
Cohesion: 0.06
Nodes (29): BacktestResult, Aggregate results of a backtest run., BaseStrategy, IronCondorStrategy, BaseStrategy, generate_legs(), Abstract base class for option strategies., Abstract base class for option strategies. (+21 more)
...
Cohesion: 0.08
Nodes (26): Result of a single completed trade., TradeResult, KillSwitchState, Tracks the DD kill switch state across the backtest., FeatureExtractor, Extracts ML features including cross-geo disruption and macro indicators.      M, BrokenWingButterflyStrategy, Broken Wing Butterfly (Put side): Asymmetric risk.     Short 2x ATM puts, Long 1 (+18 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (26): FillSnapshot, Leg, Apply an adjustment: close specified legs, add new ones, track cost., Apply an adjustment: close specified legs, add new ones, track cost., Complete multi-leg trade., Trade, A sample iron-condor-style trade with 4 legs., sample_trade() (+18 more)
...
Cohesion: 0.11
Nodes (24): OptionType, EntryDecision, _estimate_win_prob(), ExpiryCandidate, ExpirySelector, _min_short_distance_pct(), NoEntry, Multi-expiry strategy evaluator.  Instead of locking into a single target DTE, e (+16 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (31): _budget_dates(), build_event_calendar(), _election_dates(), EventCalendar, MarketEvent, _monthly_expiry_dates(), NakedPositionError, ProductionGate (+23 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (24): ConditionalGapModel, DynamicWeeklyExit, _get_cache_dir(), load_risk_engine(), Weekly Risk Engine — replaces the prediction-based WeeklyEntryLearner.  Philosop, Returns P(tail event) in [0, 1]. Higher = more dangerous., Computes Expected Tail Loss conditioned on current market state.     Not a raw h, Fit conditional gap distributions from historical OHLCV data. (+16 more)
...
Cohesion: 0.11
Nodes (24): main(), Test and validate Fyers API connection and data fetching., build_daily_sector_proxy(), expand_month_window(), iter_month_starts(), _build_official_reconstructed_frame(), _cache_path_for_record(), _find_profile() (+16 more)
...
Cohesion: 0.12
Nodes (22): add_trade(), add_trade_from_legs(), cache_age_days(), close_trade(), ClosedTradeRecord, _infer_strategy_code(), _is_supported_training_strategy(), load() (+14 more)
...
Cohesion: 0.16
Nodes (11): Configuration for weekly (3-8 DTE) options backtesting., Configuration for weekly (3-8 DTE) options backtesting., WeeklyBacktestConfig, test_combined_engine_pending_monthly_entry_fills_next_bar(), At VIX=23 with a monthly trade open, weekly should NOT be blocked (cap=25)., At VIX=26 with a monthly trade open, weekly must be blocked (cap=25)., BacktestEngine._get_expiry_date must delegate to expiry_calendar so that     pos, After a losing trade closes, the equity passed to position_sizer         must be (+3 more)
...
Cohesion: 0.16
Nodes (9): CombinedBacktestEngine, Rough net delta estimate for the weekly spread., Rough net delta estimate for the weekly spread., Rough net delta estimate for the weekly spread., Rough net delta estimate for the weekly spread., Concurrent monthly+weekly options backtester on shared capital.      Architectur, Concurrent monthly+weekly options backtester on shared capital.      Architectur, Concurrent monthly+weekly options backtester on shared capital.      Architectur (+1 more)
...
Cohesion: 0.18
Nodes (20): Rolling Window Trade Simulator — generates 1000+ training samples from 7 years o, Simulates overlapping trades across the full dataset.      For each entry date (, RollingWindowSimulator, SimConfig, WalkForwardWindow, WeeklySimConfig, _filter_trades_in_window(), LayeredEvolveArtifacts (+12 more)
...
Cohesion: 0.1
Nodes (15): BacktestEngine, Event-driven backtesting engine.     Steps through each trading day, checks entr, MarketDataFetcher, Fetches and preprocesses all market data needed for backtesting., Fetches and preprocesses all market data needed for backtesting., analyze_exit_logic(), Track which exit logic triggers in practice., Verify monthly_max_risk_per_trade_pct lowered to 10.0. (+7 more)
...
Cohesion: 0.12
Nodes (14): DrawdownKillSwitch, Hard circuit breaker that activates at max_dd_pct drawdown.      When triggered:, Hard circuit breaker that activates at max_dd_pct drawdown.      When triggered:, True on the activation tick — close weekly positions immediately., True on the activation tick — close weekly positions immediately., True on the activation tick — close monthly positions immediately., With dd_recovery_pct=0.16, DD at 17% (above recovery) should keep gate closed., Kill switch must lift once DD recovers below dd_recovery_pct. (+6 more)

### Community 57 - "Community 57"
Cohesion: 0.12
Nodes (13): Weekly Entry Learner — lightweight ML quality gate for short-DTE weekly options., Predict quality score for a weekly entry candidate.          Returns quality_sco, Extract features specific to short-DTE weekly trades., ML quality gate for weekly option entries.      Trained on simulated weekly trad, Train the weekly quality gate.          Args:             weekly_trades: list of, _sf(), WeeklyEntryLearner, test_backtest_combined_uses_final_caches_only() (+5 more)
...
Cohesion: 0.15
Nodes (11): Period-aware walk-forward model training and cache management., WalkForwardBundle, build(), metadata_from_state(), ModelPeriodMetadata, _normalize_value(), Helpers for period-aware model caches and strict out-of-sample guards., stable_config_hash() (+3 more)
...
Cohesion: 0.21
Nodes (10): IntEnum, cache_age_days(), load(), Regime-Aware Entry Model: trains separate TradeLearner per market regime.  Inste, Wraps multiple TradeLearners — one per regime.      Replaces the single global T, Regime, _DummyFeatureExtractor, _DummyRegressor (+2 more)
...
Cohesion: 0.19
Nodes (7): get_monthly_expiries(), get_monthly_expiry(), get_upcoming_expiries(), Next ``count`` *monthly* expiries with DTE info.     Weekday is Monday or Thursd, Last expiry day of the month.     Uses Monday for dates >= 2024-04-04, Thursday, All monthly expiry dates in [start, end]., TestExpiryCalendar
...
Cohesion: 0.24
Nodes (10): _DummyStrategy, _priced(), _put_spread(), Tests for the monthly expiry selector hard filters and no-trade handling., selector_patches(), test_high_loss_credit_candidate_is_rejected(), test_legacy_or_unfrozen_strategy_names_are_ignored(), test_negative_ev_candidate_is_rejected() (+2 more)
...
Cohesion: 0.21
Nodes (9): _expiry_weekday(), get_next_weekly_expiry(), get_upcoming_weekly_expiries(), get_weekly_expiries(), Nifty option expiry calendar.  NSE moved NIFTY expiries twice in recent years:, Next weekly expiry *after* ``from_date`` (Mon or Thu depending on era).     Retu, Next ``count`` weekly expiries (Mon or Thu) with DTE info., Return calendar weekday constant for NSE expiry on the given date. (+1 more)
...
Cohesion: 0.2
Nodes (6): Verify new hard max-loss cap and lower max-loss-to-credit-ratio., BacktestConfig.monthly_hard_max_loss_pct == 15.0 (relaxed from 8.0 to avoid over, BacktestConfig.monthly_max_loss_to_credit_ratio == 6.0 (lowered from 12)., Trade entry rejected if max_loss * lots * lot_size > equity * 8%., Trade entry allowed if max_loss * lots * lot_size <= cap., TestMonthlyHardMaxLossCap

### Community 95 - "Community 95"
Cohesion: 0.2
Nodes (6): Verify new tighter stop-loss thresholds: 50/45/40/35 instead of 80/65/55/45., VIX < 15: stop_loss = 50%., VIX 15-20: stop_loss = 45%., VIX 20-30: stop_loss = 40%., VIX >= 30: stop_loss = 35%., TestMonthlyStopLossThresholds
...
Cohesion: 0.25
Nodes (9): format_expiry_label(), get_all_expiries(), Human-readable expiry label, e.g. '28 Apr 2026'., Next ``count`` expiries mixing both weekly AND monthly dates.      In the Monday, Combined monthly + weekly trade signal — mirrors CombinedBacktestEngine.      Ar, Combined monthly + weekly trade signal — mirrors CombinedBacktestEngine.      Ar, Combined monthly + weekly trade signal — mirrors CombinedBacktestEngine.      Ar, Combined monthly + weekly trade signal — mirrors CombinedBacktestEngine.      Ar (+1 more)
...
Cohesion: 0.21
Nodes (5): Check if the kill switch should be active.         Returns True if all trading s, Check if the kill switch should be active.         Returns True if all trading s, Check all dynamic exit conditions. Returns first trigger hit., Check dynamic exit rules. Called each day during the trade., WeeklyExitSignal
...
Cohesion: 0.29
Nodes (4): get_best_expiry_for_dte(), get_next_monthly_expiry(), Monthly expiry closest to ``target_dte`` days out. Returns (expiry, actual_dte)., Next monthly expiry on or after ``from_date``.
...
Cohesion: 0.4
Nodes (4): Compute a continuous [0, 1] scale factor for weekly lot sizing based on, Compute a continuous [0, 1] scale factor for weekly lot sizing based on, Compute a continuous [0, 1] scale factor for weekly lot sizing based on, Compute a continuous [0, 1] scale factor for weekly lot sizing based on
...
Cohesion: 0.5
Nodes (3): ProductionRulesConfig, All production safety parameters in one place., All production safety parameters in one place.
...
## Knowledge Gaps
- **1429 isolated node(s):** `Check if Fyers token is valid during market hours and show helpful warning if ex`, `Return short git commit hash, or 'unknown' if not in a repo.`, `Aggregate per-strategy stats from trade list.`, `Aggregate sizing decisions from the engine for logging.`, `Append a structured entry to BACKTEST_CHANGELOG.md and backtest_runs.jsonl.` (+1424 more)
...
- **Why does `main()` connect `Community 26` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 11`, `Community 17`, `Community 19`, `Community 29`, `Community 34`, `Community 39`, `Community 43`, `Community 45`, `Community 47`, `Community 50`, `Community 57`, `Community 60`, `Community 63`, `Community 195`, `Community 196`, `Community 71`, `Community 74`, `Community 77`, `Community 84`, `Community 85`, `Community 86`, `Community 88`, `Community 92`, `Community 98`, `Community 99`, `Community 100`, `Community 104`, `Community 116`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `BacktestConfig` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 11`, `Community 12`, `Community 19`, `Community 26`, `Community 29`, `Community 30`, `Community 34`, `Community 39`, `Community 45`, `Community 47`, `Community 49`, `Community 50`, `Community 56`, `Community 57`, `Community 60`, `Community 64`, `Community 69`, `Community 75`, `Community 77`, `Community 85`, `Community 88`, `Community 93`, `Community 94`, `Community 95`, `Community 98`, `Community 99`, `Community 101`, `Community 106`, `Community 117`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `CombinedBacktestEngine` connect `Community 45` to `Community 1`, `Community 4`, `Community 6`, `Community 135`, `Community 136`, `Community 137`, `Community 7`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 19`, `Community 26`, `Community 29`, `Community 34`, `Community 39`, `Community 49`, `Community 50`, `Community 56`, `Community 68`, `Community 197`, `Community 75`, `Community 82`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 101`, `Community 115`, `Community 117`?**
