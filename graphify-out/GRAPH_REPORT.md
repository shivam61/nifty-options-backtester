...
## Corpus Check
- 165 files · ~283,078 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3332 nodes · 6392 edges · 257 communities (230 shown, 27 thin omitted)
- Extraction: 68% EXTRACTED · 32% INFERRED · 0% AMBIGUOUS · INFERRED: 2015 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2c89ebe9`
...
Cohesion: 0.08
Nodes (35): BacktestEngine, Event-driven backtesting engine.     Steps through each trading day, checks entr, Result of a single completed trade., TradeResult, KillSwitchState, Tracks the DD kill switch state across the backtest., Configuration for weekly (3-8 DTE) options backtesting., Configuration for weekly (3-8 DTE) options backtesting. (+27 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (25): AdjustmentAction, Leg, Apply an adjustment: close specified legs, add new ones, track cost., Apply an adjustment: close specified legs, add new ones, track cost., Check if the trade should be adjusted instead of exited.         Returns an Adju, Check if the trade should be adjusted instead of exited.         Returns an Adju, Describes a mid-trade adjustment (roll, add hedge, widen, etc.)., Complete multi-leg trade. (+17 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (40): strategy_name(), ActiveTrade, add_trade(), add_trade_from_legs(), cache_age_days(), close_trade(), ClosedTradeRecord, ExitRecommendation (+32 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (21): IntEnum, Walk-forward validation for the RegimeClassifier.      Uses expanding yearly win, validate_regime_classifier(), _is_vol_crush(), label_regime_rules(), Regime Classifier: Labels each trading day into one of 4 regimes.  Regimes:   LO, Rule-based regime labeling — used as ground truth for ML training.      NOTE: Th, ML-backed regime classifier with rule-based fallback.      Training: uses rule-b (+13 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (32): Initialize Fyers client.                  Args:             client_id: Fyers App, Validate that the connection and authentication are working.                  Re, ConditionalGapModel, DynamicWeeklyExit, _get_cache_dir(), load_risk_engine(), Weekly Risk Engine — replaces the prediction-based WeeklyEntryLearner.  Philosop, Returns P(tail event) in [0, 1]. Higher = more dangerous. (+24 more)
...
Cohesion: 0.08
Nodes (24): Walk-forward validation for the entry model (TradeLearner).      Expanding windo, walk_forward_entry_model(), Regime-Aware Entry Model: trains separate TradeLearner per market regime.  Inste, ML model that learns from multi-strategy backtests to predict: 1. WHEN to trade, Recommend the best strategy for current conditions.         In hybrid mode, elig, Suggest optimal parameters based on conditions + macro., Multi-strategy ML model that learns from regime-adaptive backtests.      Learns:, Train trade-quality filter on backtest results.          Key design changes from (+16 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (25): BaseStrategy, IronCondorStrategy, generate_legs(), Abstract base class for option strategies., should_enter(), IronCondorStrategy, Iron Condor strategy with configurable parameters. Adapts strike selection based, Entry rules:         1. VIX must be above 14 (enough premium to collect) (+17 more)
...
Cohesion: 0.08
Nodes (24): BacktestResult, Aggregate results of a backtest run., FillSnapshot, WeeklyBacktestResult, WeeklyTradeResult, Enum, CostModel, Volatility and moneyness-scaled slippage (v4). (+16 more)
...
Cohesion: 0.1
Nodes (19): Period-aware walk-forward model training and cache management., WalkForwardBundle, WalkForwardWindow, metadata_from_state(), ModelPeriodMetadata, Walk-forward validation for the weekly entry model (WeeklyEntryLearner).      Ex, walk_forward_weekly_entry_model(), cache_age_days() (+11 more)
...
Cohesion: 0.14
Nodes (5): _hash_snapshot(), MonthlyDiagnosticsCollector, Monthly-only trade funnel and exit attribution recorder., _safe_float(), _render_markdown()
...
Cohesion: 0.1
Nodes (17): BacktestConfig, test_backtest_combined_uses_final_caches_only(), test_combined_engine_pending_monthly_entry_fills_next_bar(), test_smart_engine_pending_entry_fills_next_bar(), test_walk_forward_bundle_is_strictly_oos(), test_walk_forward_cache_only_does_not_train_on_miss(), TestBacktestConfig, Verify monthly_max_risk_per_trade_pct lowered to 10.0. (+9 more)
...
Cohesion: 0.1
Nodes (13): Simulate a circuit breaker trigger with multi-asset stress., test_circuit_breaker_output(), Test with moderate stress (only 2-3 assets stressed)., Test with only one extreme factor (deep correction only)., Test with low stress (all assets normal)., test_low_stress(), test_moderate_stress(), test_single_factor_extreme() (+5 more)

### Community 49 - "Community 49"
Cohesion: 0.1
Nodes (12): CombinedBacktestEngine, CombinedResult, Combined monthly + weekly options backtesting engine.  Runs both tracks concurre, Concurrent monthly+weekly options backtester on shared capital.      Architectur, Concurrent monthly+weekly options backtester on shared capital.      Architectur, Concurrent monthly+weekly options backtester on shared capital.      Architectur, Return a formatted per-gate funnel summary for monthly trade entry.          Pri, Transparent record of how lot count was determined. (+4 more)
...
Cohesion: 0.13
Nodes (11): Weekly options backtesting engine.  Simplified engine for 3-8 DTE weekly Nifty o, Price the current close-out debit for a multi-leg trade., Compute realized exit P&L.          Baseline uses the current mark-to-market. Re, VIX-based strategy selection for weeklies., Calculate transaction costs for a trade., Execute weekly options backtest., Event-driven backtester for weekly options.      Key differences from SmartBackt, WeeklyBacktestEngine (+3 more)
...
Cohesion: 0.24
Nodes (7): Fetch option chain with best available data.         target_expiry: "DD-Mon-YYYY, CDSLAdapter, parse_cdsl_archive_input(), raw_path(), write_bytes(), write_json(), write_text()

### Community 67 - "Community 67"
Cohesion: 0.22
Nodes (6): FeatureExtractor, Extract features from a market data row.          Returns None if critical field, Extracts ML features including cross-geo disruption and macro indicators.      M, FeatureExtractor.extract() must read 'overnight_gap_pct' (the column name     pr, _DummyFeatureExtractor, TestFeatureExtractor
...
Cohesion: 0.13
Nodes (8): Multi-layer risk gate for weekly entries.          Returns None if entry is allo, Multi-layer risk gate for weekly entries.          Returns None if entry is allo, VIX-adaptive exits + trailing stops + ML override for monthly., VIX-adaptive exits + trailing stops + ML override for monthly., VIX-adaptive exits + trailing stops + ML override for monthly., VIX-adaptive exits + trailing stops + ML override for monthly., Multi-layer risk gate for weekly entries.          Returns None if entry is allo, Multi-layer risk gate for weekly entries.          Returns None if entry is allo
...
Cohesion: 0.12
Nodes (16): main(), Add a trade — supports both --leg format and legacy single-spread format., Add a trade — supports both --leg format and legacy single-spread format., Remove a trade, or archive+close it when realized P&L is provided., Remove a trade, or archive+close it when realized P&L is provided., Explicit close/archive wrapper around the trade journal., Explicit close/archive wrapper around the trade journal., List all active trades with leg details. (+8 more)
...
Cohesion: 0.13
Nodes (12): MarketDataFetcher, Fetches and preprocesses all market data needed for backtesting., Fetches and preprocesses all market data needed for backtesting., analyze_exit_logic(), Track which exit logic triggers in practice., Combined monthly + weekly trade signal — mirrors CombinedBacktestEngine.      Ar, Combined monthly + weekly trade signal — mirrors CombinedBacktestEngine.      Ar, run_signal_combined() (+4 more)
...
Cohesion: 0.18
Nodes (11): find_best_iron_condor_strikes(), Find the best liquid strikes for an Iron Condor.     Returns actual market price, _print_leg_details(), _print_live_trade(), _print_trade_summary(), Print trade using actual live prices from option chain., Print trade using actual live prices from option chain., Print leg details with live data. (+3 more)

### Community 87 - "Community 87"
Cohesion: 0.18
Nodes (10): _check_fyers_token_and_warn(), _expiry_matches(), Check if the live option chain expiry matches our target., Check if the live option chain expiry matches our target., Check if Fyers token is valid during market hours and show helpful warning if ex, Generate ML-powered multi-strategy trade signal., Generate ML-powered multi-strategy trade signal., run_signal() (+2 more)
...
Cohesion: 0.22
Nodes (9): _generate_sim_trades(), Rolling-window simulated trades for ML training; filtered to strategies enabled, Rolling-window simulated trades for ML training; filtered to strategies enabled, v4: Ablation study — measure contribution of each strategy and ML exit., v4: Ablation study — measure contribution of each strategy and ML exit., v4: Stress test — replay crisis periods with conservative fills., v4: Stress test — replay crisis periods with conservative fills., run_ablation() (+1 more)
...
Cohesion: 0.33
Nodes (6): _print_strategy_bs_trade(), _print_strategy_trade(), Generate a strategy-specific trade using live OI data + BS pricing., Generate a strategy-specific trade using live OI data + BS pricing., Fallback: BS-only pricing when live data unavailable., Fallback: BS-only pricing when live data unavailable.
...
Cohesion: 0.67
Nodes (3): Evolve strategy parameters: exhaustive search over 1080 combos × 4 regimes., Evolve strategy parameters: exhaustive search over 1080 combos × 4 regimes., run_evolve()

### Community 195 - "Community 195"
Cohesion: 0.67
Nodes (3): _print_exit_recommendation(), Pretty-print exit recommendation for any multi-leg trade., Pretty-print exit recommendation for any multi-leg trade.

### Community 197 - "Community 197"
Cohesion: 0.67
Nodes (3): _print_oi_guided_trade(), Use live OI data for strike selection, BS for pricing on target expiry., Use live OI data for strike selection, BS for pricing on target expiry.

### Community 198 - "Community 198"
Cohesion: 0.67
Nodes (3): _print_bs_fallback_trade(), Fallback: print BS-estimated trade when live data unavailable., Fallback: print BS-estimated trade when live data unavailable.
...
## Knowledge Gaps
- **1395 isolated node(s):** `Check if Fyers token is valid during market hours and show helpful warning if ex`, `Return short git commit hash, or 'unknown' if not in a repo.`, `Aggregate per-strategy stats from trade list.`, `Aggregate sizing decisions from the engine for logging.`, `Append a structured entry to BACKTEST_CHANGELOG.md and backtest_runs.jsonl.` (+1390 more)
...
- **Why does `main()` connect `Community 30` to `Community 1`, `Community 3`, `Community 5`, `Community 9`, `Community 11`, `Community 15`, `Community 31`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 48`, `Community 49`, `Community 52`, `Community 63`, `Community 64`, `Community 194`, `Community 66`, `Community 71`, `Community 74`, `Community 76`, `Community 77`, `Community 79`, `Community 87`, `Community 94`, `Community 95`, `Community 96`, `Community 98`, `Community 101`, `Community 102`, `Community 111`, `Community 112`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `BacktestConfig` connect `Community 41` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 7`, `Community 11`, `Community 12`, `Community 19`, `Community 28`, `Community 30`, `Community 31`, `Community 34`, `Community 49`, `Community 51`, `Community 56`, `Community 57`, `Community 58`, `Community 65`, `Community 67`, `Community 74`, `Community 77`, `Community 79`, `Community 90`, `Community 91`, `Community 94`, `Community 95`, `Community 96`, `Community 97`, `Community 98`, `Community 103`, `Community 104`, `Community 112`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `CombinedBacktestEngine` connect `Community 49` to `Community 0`, `Community 3`, `Community 4`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 17`, `Community 19`, `Community 30`, `Community 37`, `Community 41`, `Community 51`, `Community 56`, `Community 57`, `Community 63`, `Community 67`, `Community 68`, `Community 69`, `Community 84`, `Community 90`, `Community 91`, `Community 92`, `Community 97`, `Community 112`, `Community 114`?**
